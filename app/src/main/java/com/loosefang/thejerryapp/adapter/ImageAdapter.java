...
import com.loosefang.thejerryapp.HomeActivity;
...
public class ImageAdapter extends BaseAdapter {
	...
	public List<MainActivityList> images;
	
	public ImageAdapter(Activity act,List<MainActivityList> imgs) {
		inflater=LayoutInflater.from(act);
		this.images=imgs;
		this.activity=act;
	}
	public void getMainActivityImages(){
		images = HomeActivity.initialiseList();
	}
	
	@Override
	public int getCount() {
		getMainActivityImages();
		return images.size();
	}
